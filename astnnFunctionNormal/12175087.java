class BackupThread extends Thread {
    public void fill(String src, String dest, String user) throws IOException, DocumentException {
        ...
        fields.setFieldProperty("buildamerica", "textsize", new Float(20.2), null);
        fields.setFieldProperty("buildamerica", "textfont", baseFont, null);
        fields.setField("buildamerica", this.get_buildamerica());
        ...
        fields.setFieldProperty("vsac", "textsize", new Float(20.2), null);
        fields.setFieldProperty("vsac", "textfont", baseFont, null);
        fields.setField("vsac", this.get_vsac());
        ...
        fields.setFieldProperty("AdjustedGrossIncome113", "textsize", new Float(20.2), null);
        fields.setFieldProperty("AdjustedGrossIncome113", "textfont", baseFont, null);
        fields.setField("AdjustedGrossIncome113", this.get_AdjustedGrossIncome113());
        ...
        fields.setFieldProperty("NonVtIncome113", "textsize", new Float(20.2), null);
        fields.setFieldProperty("NonVtIncome113", "textfont", baseFont, null);
        fields.setField("NonVtIncome113", this.get_NonVtIncome113());
        fields.setFieldProperty("vttele", "textsize", new Float(20.2), null);
        fields.setFieldProperty("vttele", "textfont", baseFont, null);
        fields.setField("vttele", this.get_vttele());
