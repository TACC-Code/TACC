class BackupThread extends Thread {
    @Test
    public void test_validate_tag_TetWeeklyArtistChart() {
        try {
            SchemaFactory factory = SchemaFactory.newInstance("http://www.w3.org/2001/XMLSchema");
            File schemaLocation = new File("tes.xsd");
            Schema schema = factory.newSchema(schemaLocation);
            Validator validator = schema.newValidator();
            URL url = new URL("http://ws.audioscrobbler.com/2.0/?method=tag.getweeklyartistchart&tag=disco&api_key=b25b959554ed76058ac220b7b2e0a026");
